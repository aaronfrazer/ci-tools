...
class Blade
{
    ...
    /**
     * Find the full path to a views file. Shows an error if file not found.
     *
     * @param string $view
     * @return string
     */
    ...
    protected function _compile($template)
    {
        ...
        {
            // In production, avoid to bootstrap if the template was updated
    ...
    protected function _compile_forelse($value)
    {
        ...
        foreach ($matches[0] as $forelse)
        {
            ...
            // all instances of this forelse syntax in the views content of the
            // views being compiled to Blade syntax with real PHP syntax.
